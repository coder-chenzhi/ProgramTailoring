...
/**
 * A host (typically Unit) has this tag if it is reachable under
 * bottom-up analysis.
 *
 */
public enum BottomUpReachableTag implements Tag {
	// Enable singleton pattern; 
	INSTANCE;
		
	public static final String NAME = "BottomUpReachableTag";
